...
export const translations = {
  ko: {
    ...
    submittingGeneration: "생성 요청 제출 중...",
    generatingVideosProgress: "비디오 생성 중...",
    someVideosFailed: "{count}개 비디오 생성에 실패했습니다",
    generationFailed: "비디오 생성에 실패했습니다. 다시 시도해 주세요.",
    clipsCompleted: "클립 완료",
    videos: "비디오",
    chatPrompt1: "채팅에서 광고 요청을 입력하면",
    chatPrompt2: "스토리보드가 여기에 생성됩니다",
    aiAsking: "AI가 궁금한 점을 여쭤보고 있어요",
    checkChat: "채팅창을 확인해 주세요",
    generating: "생성 중...",
    generate: "생성하기",
    seconds: "초",
  ...
  en: {
    ...
    submittingGeneration: "Submitting generation request...",
    generatingVideosProgress: "Generating videos...",
    someVideosFailed: "{count} video(s) failed to generate",
    generationFailed: "Video generation failed. Please try again.",
    clipsCompleted: "clips completed",
    videos: "videos",
    chatPrompt1: "Enter your ad request in the chat",
    chatPrompt2: "and the storyboard will be generated here",
    aiAsking: "AI is asking a few questions",
    checkChat: "Please check the chat",
